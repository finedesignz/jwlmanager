...
.DESCRIPTION
  ...
  has NO signCommand, so normal local/dev/PR builds never invoke this file. See ./README.md.
...
.EXAMPLE
  ...
  .\signing\sign.ps1 "C:\path\to\JWL Manager_0.1.0_x64_en-US.msi"
#>
...
See app/src-tauri/signing/README.md.
"@
    exit 1
}
